...
export const Footer: FC = () => {
    return (
        <div className="">
            ...
            <div className="ml-12 py-16 mr-12">
...
<div className="grid grid-cols-2 md:grid-cols-6 gap-2 md:gap-8 md:space-x-12 relative">
    ...
    <div className='flex flex-col col-span-2 mx-4 items-center md:items-start'>
            <div className='flex flex-row ml-1'>
                <svg width="80%" height="20" viewBox="0 0 646 96" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="https://twitter.com/solanauni" type="button" className="border-white text-secondary hover:text-white leading-normal hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1">
                        ...
                        <a href="https://www.linkedin.com/company/solanalabs" type="button" className="border-white text-secondary hover:text-white leading-normal hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1">
                            <svg aria-hidden="true"
                                focusable="false"
                                data-prefix="fab"
