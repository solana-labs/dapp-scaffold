...
export const Footer = () => (
  <div className='relative mb-40 mt-40'>
    <footer className='absolute w-full border-t-2 border-[#141414] bg-black hover:text-white'>
      <div className='ml-12 mr-12 py-12'>
        <div className='relative grid grid-cols-2 gap-2 md:grid-cols-6 md:gap-8 md:space-x-12'>
          <div className='col-span-2 mx-4 flex flex-col items-center md:items-start'>
            ...
            <div className='flex md:ml-2'>
              <a
                ...
                type='button'
                className='m-1 h-9 w-9 border-white leading-normal text-secondary transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-5 hover:text-white focus:outline-none focus:ring-0'
              >
                <svg
                  aria-hidden='true'
                  focusable='false'
            ...
            <div className='m-1 mb-6 place-items-start items-start font-normal tracking-tight text-secondary sm:text-left'>
              © 2023 Solana Foundation
            </div>
          </div>

          <div className='mx-auto mb-6 max-w-screen-lg items-center'>
            <div className='mb-2.5 font-normal capitalize'>SOLANA</div>
          ...
          <div className='mx-auto mb-6 max-w-screen-lg items-center'>
            <h5 className='mb-2.5 font-normal  tracking-tight'>ECOSYSTEM</h5>
