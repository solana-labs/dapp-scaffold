...
import PurchaseTray from 'components/PurchaseTray';

export const HomeView: FC = ({ }) => {
  const [showMint, setShowMint] = useState(false);
  return (
    <>
      <div className={`md:my-2 ${showMint ? 'blur-sm brightness-50 pointer-events-none' : ''}`}>
      ...
      {showMint && (
          <PurchaseTray showMint={showMint} setShowMint={setShowMint} />
      )}
    </>
  );
};
